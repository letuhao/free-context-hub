...
export default function ProjectSettingsPage() {
  ...
  return (
    ...
    <div className="flex-1 overflow-y-auto p-6">
      ...
      {/* Features Section — DEFERRED-062 §3: the inline block was extracted to the shared
          FeatureToggles component (S6). Behaviour is identical (PATCH settings.features, refetch). */}
      <FeatureToggles projectId={projectId} project={current} onChange={refreshProjects} />
