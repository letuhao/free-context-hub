---
tag: s17.x-cove-fewshot
commit: 642c83c+dirty
branch: phase-16-sprint-16.1-gen-eval-dataset
run_at: 2026-05-24T07:27:18.994Z
elapsed_ms: 121670
project_id_primary: free-context-hub
---

# RAG Baseline — s17.x-cove-fewshot
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| lessons | free-context-hub | 1 | 0 | 1 | 1 | 1 | 1 | 1 | 0 | 0 | 1 | 3246 | 3246 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| lessons | 1 | 1 | 0.67 ±0.00 (1 fail) | 0.80 ±0.00 (1 fail) | 1.00 ±0.00 | 0.40 ±0.00 (1 fail) | — | 1.00 ±0.00 |
...
|---|---|---|---|---:|
| lesson-pg-uuid-casing | confident-hit | 1 | clean | 3246 |
