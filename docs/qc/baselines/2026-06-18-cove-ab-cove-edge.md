...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| lessons | free-context-hub | 8 | 0 | 0.625 | 0.625 | 0.625 | 0.5996 | 0.5976 | 0 | 0 | 0.625 | 90 | 127 |
| code | free-context-hub | 10 | 0 | 0.1 | 0.2 | 0.0667 | 0.0631 | 0.0987 | 0 | 0 | 0.2 | 61 | 3693 |
| chunks | free-context-hub | 3 | 0 | 0.6667 | 0.6667 | 0.6667 | 0.6611 | 0.6611 | 0 | 0 | 0.6667 | 79 | 133 |
| global | free-context-hub | 4 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0.2 | 0 | 3 | 24 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| lessons | 8 | 8 | 0.67 ±0.47 (1 fail) | 0.12 ±0.19 (7 fail) | 0.69 ±0.43 (3 fail) | 0.48 ±0.33 (7 fail) | 0.00 ±0.00 (1 fail) | 0.63 ±0.48 (3 fail) |
| code | 10 | 10 | 0.50 ±0.50 (4 fail) | 0.00 ±0.00 (8 fail) | 0.08 ±0.25 (9 fail) | 0.10 ±0.30 (9 fail) | 1.00 ±0.00 | 1.00 ±0.00 |
| chunks | 3 | 3 | 1.00 ±0.00 | 0.68 ±0.15 (2 fail) | 0.67 ±0.47 (1 fail) | 0.61 ±0.28 (2 fail) | 1.00 ±0.00 | 1.00 ±0.00 |
| global | 4 | 1 | 0.75 ±0.00 (1 fail) | 0.48 ±0.00 (1 fail) | 0.00 ±0.00 (1 fail) | 0.50 ±0.00 (1 fail) | — | 0.40 ±0.00 (1 fail) |
...
**lessons** (8):
  ...
  - `lesson-edge-no-answer-1` — context_precision<0.8, context_recall<0.75, refusal_correctness<0.75
  - `lesson-edge-contradictory-1` — answer_relevancy<0.85, context_recall<0.75, groundedness_self_eval<0.85
  - `lesson-edge-contradictory-2` — answer_relevancy<0.85, context_precision<0.8, context_recall<0.75
  - _(+3 more)_
...
|---|---|---|---|---:|
| lesson-edge-multi-hop-1 | edge-multi-hop | — | no-relevant-hit | 89 |
| lesson-edge-multi-hop-2 | edge-multi-hop | 1,2,7 | clean | 86 |
| lesson-edge-no-answer-1 | edge-no-answer | — | — | 91 |
| lesson-edge-contradictory-1 | edge-contradictory | 1 | clean | 86 |
| lesson-edge-contradictory-2 | edge-contradictory | — | no-relevant-hit | 91 |
| lesson-edge-paraphrase-1 | edge-paraphrase | 1 | clean | 93 |
| lesson-edge-paraphrase-2 | edge-paraphrase | 1 | clean | 90 |
| lesson-edge-distractor-1 | edge-distractor | 1 | clean | 93 |

## code — per-query detail

| id | group | found@ | friction | p50 ms |
|---|---|---|---|---:|
| code-edge-multi-hop-1 | edge-multi-hop | 6 | rank-order-inversion | 3693 |
| code-edge-no-answer-1 | edge-no-answer | — | — | 3032 |
| code-edge-no-answer-2 | edge-no-answer | — | — | 54 |
| code-edge-contradictory-1 | edge-contradictory | — | no-relevant-hit | 55 |
| code-edge-contradictory-2 | edge-contradictory | — | no-relevant-hit | 56 |
| code-edge-paraphrase-1 | edge-paraphrase | — | no-relevant-hit | 59 |
| code-edge-paraphrase-2 | edge-paraphrase | — | no-relevant-hit | 60 |
| code-edge-distractor-1 | edge-distractor | 2 | clean | 52 |
...
| id | group | found@ | friction | p50 ms |
|---|---|---|---|---:|
| chunk-edge-multi-hop-1 | edge-multi-hop | 1,2,4 | clean | 82 |
| chunk-edge-no-answer-1 | edge-no-answer | — | — | 72 |
| chunk-edge-distractor-1 | edge-distractor | 1 | clean | 71 |

## global — per-query detail

| id | group | found@ | friction | p50 ms |
|---|---|---|---|---:|
| global-edge-multi-hop-1 | edge-multi-hop | — | empty-result-set;no-relevant-hit | 6 |
...
- **code/code-edge-multi-hop-1** — rank-order-inversion: query `How does index_project hand off chunks to the embedding service before writing t`; top-3 keys=[packages/mcp-client/src/index.ts, src/services/documentChunks.ts, src/services/extraction/pipeline.ts]
