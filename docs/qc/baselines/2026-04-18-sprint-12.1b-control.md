...
| chunk-retry-implementation-code | confident-hit | 1 | clean | 47 |
| chunk-authentication-overview | confident-hit | 1 | clean | 47 |
| chunk-role-definitions | confident-hit | 1 | clean | 45 |
| chunk-data-storage-pgvector | confident-hit | 1 | clean | 51 |
| chunk-adr-intro-dup | duplicate-trap | 1,2 | clean | 46 |
| chunk-cross-retry-auth-storage | cross-topic | 3,5,8 | clean | 45 |
| chunk-miss-quantum | adversarial-miss | — | — | 42 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| chunks | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 1 | 98 | 17 |
