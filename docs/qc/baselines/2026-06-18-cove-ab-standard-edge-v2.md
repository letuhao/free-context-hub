---
tag: cove-ab-standard-edge-v2
commit: ab53ed5
branch: fix-model-swap-orchestration
run_at: 2026-06-18T09:30:15.041Z
elapsed_ms: 346117
project_id_primary: free-context-hub
---

# RAG Baseline — cove-ab-standard-edge-v2
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| lessons | free-context-hub | 8 | 0 | 0.625 | 0.625 | 0.625 | 0.5996 | 0.5976 | 0 | 0 | 0.625 | 90 | 120 |
| code | free-context-hub | 10 | 0 | 0.1 | 0.1 | 0.05 | 0.0631 | 0.0631 | 0 | 0 | 0.1 | 56 | 3589 |
| chunks | free-context-hub | 3 | 0 | 0.6667 | 0.6667 | 0.6667 | 0.6611 | 0.6611 | 0 | 0 | 0.6667 | 74 | 84 |
| global | free-context-hub | 4 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0.2 | 0 | 3 | 29 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| lessons | 8 | 8 | 0.81 ±0.35 (2 fail) | 0.33 ±0.39 (6 fail) | 0.68 ±0.43 (3 fail) | 0.52 ±0.37 (6 fail) | 1.00 ±0.00 | 1.00 ±0.00 |
| code | 10 | 10 | 0.63 ±0.48 (3 fail) | 0.00 ±0.00 (8 fail) | 0.18 ±0.37 (8 fail) | 0.10 ±0.30 (9 fail) | 1.00 ±0.00 | 1.00 ±0.00 |
| chunks | 3 | 3 | 1.00 ±0.00 | 0.67 ±0.16 (2 fail) | 0.67 ±0.47 (1 fail) | 0.61 ±0.28 (2 fail) | 1.00 ±0.00 | 1.00 ±0.00 |
| global | 4 | 1 | 0.75 ±0.00 (1 fail) | 0.35 ±0.00 (1 fail) | 0.00 ±0.00 (1 fail) | 0.50 ±0.00 (1 fail) | — | 0.40 ±0.00 (1 fail) |
...
**lessons** (8):
  - `lesson-edge-multi-hop-1` — answer_relevancy<0.85, context_precision<0.8, context_recall<0.75
...
|---|---|---|---|---:|
| lesson-edge-multi-hop-1 | edge-multi-hop | — | no-relevant-hit | 93 |
| lesson-edge-multi-hop-2 | edge-multi-hop | 1,2,7 | clean | 91 |
| lesson-edge-no-answer-1 | edge-no-answer | — | — | 93 |
| lesson-edge-contradictory-1 | edge-contradictory | 1 | clean | 86 |
| lesson-edge-contradictory-2 | edge-contradictory | — | no-relevant-hit | 85 |
| lesson-edge-paraphrase-1 | edge-paraphrase | 1 | clean | 91 |
| lesson-edge-paraphrase-2 | edge-paraphrase | 1 | clean | 89 |
| lesson-edge-distractor-1 | edge-distractor | 1 | clean | 90 |

## code — per-query detail

| id | group | found@ | friction | p50 ms |
|---|---|---|---|---:|
| code-edge-multi-hop-1 | edge-multi-hop | — | no-relevant-hit | 3589 |
| code-edge-no-answer-1 | edge-no-answer | — | — | 3010 |
...
| code-edge-distractor-1 | edge-distractor | 2 | clean | 54 |
| code-edge-distractor-2 | edge-distractor | — | no-relevant-hit | 61 |
...
| id | group | found@ | friction | p50 ms |
|---|---|---|---|---:|
| chunk-edge-multi-hop-1 | edge-multi-hop | 1,2,4 | clean | 65 |
| chunk-edge-no-answer-1 | edge-no-answer | — | — | 70 |
| chunk-edge-distractor-1 | edge-distractor | 1 | clean | 81 |
...
- **code/code-edge-multi-hop-1** — no-relevant-hit: query `How does index_project hand off chunks to the embedding service before writing t`; top-3 keys=[packages/mcp-client/src/index.ts, src/smoke/smokeTest.ts, src/worker.ts]
