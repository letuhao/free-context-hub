...
export async function createBody(params: {
  ...
  await assertAuthorized(params.actingPrincipalId, 'admin', { kind: 'project', id: resolvedProjectId });
...
export async function addBodyMember(params: {
  ...
  await assertAuthorized(params.actingPrincipalId, 'admin', { kind: 'body', id: params.body_id });
 ...
 */
export async function getBody(params: { body_id: string; actingPrincipalId?: string | null }): Promise<BodyRecord | null> {
 ...
 */
export async function listBodies(params: { project_id?: string; actingPrincipalId?: string | null }): Promise<ListBodiesResult> {
  const projectId = resolveProjectIdOrThrow(params.project_id);
