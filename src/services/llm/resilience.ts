/**
 * Resilience layer for LM-Studio-backed LLM calls.
 *
 * (Relocated from src/qc/llmResilience.ts 2026-06-18 — it is a generic
 * LLM-transport concern, not a qc concern. The old path re-exports from here.)
 *
