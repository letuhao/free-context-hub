...
async function main() {
  ...
  // Group 7: Activity, Analytics, Learning Paths (REST-based).
  console.log('\n── Activity & Analytics ──');
  allResults.push(...await runTests(allActivityAnalyticsTests, ctx));

  // Group 8: Global Search & Agents (REST-based).
